...
extern "C"
{
     ...
     *
     * This function reads and returns the current logic level of the specified GPIO pin.
     *
     * @param gpio_num The GPIO number to read from.
     * @return
     *      - 0: GPIO pin is at logic level 0 (low).
     *      - 1: GPIO pin is at logic level 1 (high).
     */
