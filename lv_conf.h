...
/*Default display refresh period. LVL will redraw changed areas with this period time*/
 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 by default
 *If you are not sure what to do leave it disabled*/
#define LV_DITHER_GRADIENT 0
     ...
     *The increase in CPU consumption is 3-times the rendering time of the object. */
 ...
 *should also appear on LVGL binding API such as Micropython or JavaScript.*/
 ...
 *The font files can be generated automatically by the Fonts tab in SquareLine Studio*/
